...
public class Home_page 
{
   ...
   public static  SoftAssert assertion= new SoftAssert();
    public static void openBrowser() throws IOException, Exception 
	{
    	...
    	f2=new FileInputStream("F:\\jar\\agentui1.xls");
		...
		driver.findElement(By.name("agent_id")).sendKeys("3131");		
	      ...
	      {
		     driver.findElement(By.xpath("html/body/form[2]/table[2]/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[5]/td/table/tbody/tr/td/input")).click();
		  }
		  Data();
